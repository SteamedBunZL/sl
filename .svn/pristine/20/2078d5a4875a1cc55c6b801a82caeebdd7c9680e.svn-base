...
public class Contacts {
	...
	public interface PeopleColumns {
		 ...
		 * character set (e.g. hiragana for Japanese). Used for pronunciation
		 * and/or collation in some languages.
		 * <p>
		 * Type: TEXT
		 * </P>
		 */
		...
		/**
		 * The display name. If name is not null name, else if number is not
		 * null number, else if email is not null email.
		 * <P>
		 * Type: TEXT
		 * </P>
		 */
	 ...
	 * ContactMethods.
	 */
	public static final class ContactMethods implements BaseColumns,
			ContactMethodsColumns, PeopleColumns {
		/**
		 * no public constructor since this is a utility class
		 */
	...
	/**
	 * Columns from the Organizations table that other columns join into
	 * themselves.
	 */
