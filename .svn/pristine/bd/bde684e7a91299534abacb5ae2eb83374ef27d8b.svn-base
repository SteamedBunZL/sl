...
public class AlbumImageView extends ImageView {
	...
	public AlbumImageView(Context context, int imageWidth, int imageHeight) {
		super(context);
		this.imageHeight = imageHeight;
		this.imageWidth = imageWidth;
		init();
	}
	public AlbumImageView(Context context, AttributeSet attrs, int imageWidth, int imageHeight) {
		super(context, attrs);
		this.imageHeight = imageHeight;
		this.imageWidth = imageWidth;
		init();
	 ...
	 public AlbumImageView(Context context,AttributeSet paramAttributeSet){
	...
	private void arithScaleRate() {
		float scaleWidth = Utils.SreenW / (float) imageWidth;
		float scaleHeight = Utils.SreenH / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		// 缩放到屏幕大小
	//zoomTo(scaleRate, Utils.SreenW / 2f, Utils.SreenH / 2f);
	...
	public void layoutToCenter() {
		...
		// 空白区域宽高
		float fill_width = Utils.SreenW - width;
		float fill_height = Utils.SreenH - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom = (Utils.SreenW / 2f) / imageWidth;
