...
//	Editor editor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_help_prompt);
        ...
        String privacy_page = HelpActivity.this.getResources().getString(R.string.help_url);
        feedbackText=(TextView) findViewById(R.id.help_ideaText);
...
//				 AlertDialog.Builder(HelpActivity.this);
...
//	String realname = prefs.getString(CommonData.REALNAME, "");
	...
	if(!"".equals(realname)){
		feedbackSubject = HelpActivity.this.getResources().getString(R.string.settings_feedback_subject);
		feedbackSubject = feedbackSubject.replace("$", realname);
	}else{
		feedbackSubject = HelpActivity.this.getResources().getString(R.string.feedback);
	}
	
    String feedbackText = HelpActivity.this.getResources().getString(R.string.settings_feedback_text);
    //系统版本
    String sysVersion = android.os.Build.VERSION.RELEASE;
    //设备名称
    String mobileModel = android.os.Build.MODEL;
    //设备ID
	TelephonyManager tm = (TelephonyManager) HelpActivity.this.getSystemService(Service.TELEPHONY_SERVICE);
	...
	String softVersion = "";
	try {
		softVersion = HelpActivity.this.getResources().getString(R.string.soft_version);
		String version = HelpActivity.this.getPackageManager().getPackageInfo(packageName, 0).versionName;
		softVersion = softVersion + version;
	} catch (NameNotFoundException e2) {
		softVersion = "";
		e2.printStackTrace();
	}
	String hardwareCategory = HelpActivity.this.getResources().getString(R.string.hardware_category);
	String operatingSystem = HelpActivity.this.getResources().getString(R.string.operating_system);
	String deviceId = HelpActivity.this.getResources().getString(R.string.device_id);
	String feedbackUsername = HelpActivity.this.getResources().getString(R.string.feedback_username);
	...
	String debug_email = HelpActivity.this.getResources().getString(R.string.debug_email);
...
//	feedbackIntent.setType("message/rfc822");
    ...
    File sddir = Utils.createDirectory(HelpActivity.this);
    if(sddir!=null){
    ...
    try {
		...
		Utils.startPromptDialog(HelpActivity.this, R.string.prompt, R.string.prompt);
