 ...
 * 
 */
public class SetGroupNewInfonActivity extends BaseActivity implements
		OnClickListener {
...
//	private UpdateReceiver updatereceiver;
	...
	private static final String TAG = SetGroupNewInfonActivity.class
			.getSimpleName();
	...
	public void onClick(View v) {
		...
		case R.id.sl_tab_setting_sign_sendBtn:
			...
			if((str_info.length() > 100)){
				Toast.makeText(SetGroupNewInfonActivity.this, "聊天室简介过长", Toast.LENGTH_SHORT).show();
				return;
			} 
            //判断空，我就不判断了。。。。  
            Intent data=new Intent();  
            data.putExtra("newinfo", str_info);  
            //请求代码可以自己设置，这里设置成20  
            setResult(RESULTCODE_FOR_RESULT_GROUPINFO, data);  
            //关闭掉这个Activity  
            finish();  
			break;
...
//		}
	...
	TextWatcher mTextWatcher = new TextWatcher() {
		...
		public void afterTextChanged(Editable s) {
			...
			if (temp.length() > 100) {
				Toast.makeText(SetGroupNewInfonActivity.this, "最多可以输入60个字符",
