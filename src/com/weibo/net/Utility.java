...
public class Utility {
    ...
    public static String openUrl(Context context, String url, String method,
        ...
        for (int loc = 0; loc < params.size(); loc++) {
            ...
            if (key.equals("pic")) {
                file = params.getByteValue(key);
                params.remove(key);
            }
        }
        if(file != null){
    	    Bitmap bitmap = Weibo.getBitmap(file);
    	    rlt = openUrl(context, url, method, params, bitmap, token);
        }else{
    ...
    public static String openUrl(Context context, String url, String method,
            WeiboParameters params, Bitmap bitmap, Token token) throws WeiboException {
        String result = "";
        try {
            ...
            if (method.equals("GET")) {
                ...
                if (bitmap != null) {
                    ...
                    Utility.imageContentToUpload(bos, bitmap);
