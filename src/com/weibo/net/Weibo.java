...
public class Weibo {
    ...
    public static String APP_KEY = "2878705404";
    public static String APP_SECRET = "58d516990c82cd57c16847e178b51e7f";
    ...
    public void showUser(Context context, Weibo weibo, String source,String uid, AsyncWeiboRunner.RequestListener listener) throws WeiboException {
        WeiboParameters bundle = new WeiboParameters();
        bundle.add("source", source);
        bundle.add("uid", uid);
        String url = Weibo.SERVER + "users/show.json";
        AsyncWeiboRunner weiboRunner = new AsyncWeiboRunner(weibo);
        weiboRunner.request(context, url, bundle, Utility.HTTPMETHOD_GET, listener);
     }
}
